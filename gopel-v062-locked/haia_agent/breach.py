...
class BreachReport:
    ...
    def finalize(self) -> None:
        ...
        SEC-04: Hash includes all metadata fields, not just events.
        Prevents tampering of overall_severity, pipeline_halted, or
        output_trustworthy without invalidating the hash.
        """
        content = json.dumps({
