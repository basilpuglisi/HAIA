        ...
        try:
            ...
            if usable_count == 0:
                ...
                if self.governance_runtime:
                    ...
                    self.governance_runtime.escalation_engine.evaluate(
                        esc_context
                    )
            ...
            # SEC-07: use public get_records() instead of _records
            transport_violations = TransportVerifier.verify_transaction_transport(
                self.logger.get_records()
            )
            ...
            if self.governance_runtime and breach_report.overall_severity != BreachSeverity.NOMINAL:
                ...
                self.governance_runtime.escalation_engine.evaluate(esc_context)
