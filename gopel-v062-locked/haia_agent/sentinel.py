...
class Sentinel:
    ...
    def __init__(self, identity: PipelineIdentity):
        ...
        self._sequence = 0
        self._seq_lock = Lock()  # SEC-01: Thread-safe sequence counter
        ...
        # SEC-11: Track callback errors for monitoring
    ...
    def callback_errors(self) -> int:
        """SEC-11: Total callback errors across heartbeat and OOB channels.

        External monitors can poll this to detect degraded delivery.
        A rising count indicates callback infrastructure problems.
        """
    ...
    def _next_sequence(self) -> int:
        ...
        SEC-01: Thread-safe under concurrent heartbeat + main thread usage.
        """
        with self._seq_lock:
            self._sequence += 1
            ...
            while not self._heartbeat_stop.is_set():
                ...
                for cb in self._heartbeat_callbacks:
                    try:
                        ...
                        # SEC-11: count callback errors for monitoring
